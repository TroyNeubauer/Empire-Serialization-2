...
__forceinline void Serialize_U128(void* value, Output& buf EMPIRE_ERROR_PARAMETER) {
	buf.Write(*static_cast<u128*>(value));
}


__forceinline void Serialize_S128(void* value, Output& buf EMPIRE_ERROR_PARAMETER) {
