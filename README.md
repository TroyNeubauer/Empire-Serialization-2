...
| Branch                 | Status                                                                                                                                 |
|:-----------------------|:--------------------------------------------------------------------------------------------------|
| ```origin/master: ```  | ![Build Status (Master)](https://travis-ci.org/TroyNeubauer/Empire-Serialization-2.svg?branch=master) |
| ```origin/dev: ``` | ![Build Status (Dev)](https://travis-ci.org/TroyNeubauer/Empire-Serialization-2.svg?branch=dev) |
